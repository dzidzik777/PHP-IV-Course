<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			$stmt = $DB_con->prepare('INSERT INTO students(name, lastName, idNumber, mobile, address) 
			VALUES(:name, :lastName, :idNumber, :mobile, :address)');
...
<form id="form1" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
        <input type="text"required autocomplete="off" name="idNumber" class="form-control" id="idNumber" placeholder="პირადი ნომერი">
        </div>
